...
use DarrynTen\Xero\Models\Accounting\Example;
// use DarrynTen\Xero\Models\ExampleCategory; // any related models
...
class ExampleModelTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->expectException(ModelException::class);
        $this->expectExceptionMessage('Model "Example" Received namespaced class "DarrynTen\Xero\Models\SomeInvalidClass" when defined type is "string" Property is referencing an undefined, non-primitive class');
    ...
    {
        $this->expectException(ModelException::class);
        $this->expectExceptionMessage('Model "Example" Received unexpected namespaced class "DarrynTen\Xero\Models\integerzzz');
